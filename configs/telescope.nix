  ...
  configs.telescope = {
    ...
    keymaps = map (nix2nvimrc.toKeymap { silent = true; }) [
      [
        "n"
        "<Leader>ff"
        (luaExpr "require'telescope.builtin'.find_files")
        { desc = "Find file"; }
      ]
      [
        "n"
        "<Leader>fF"
        (luaExpr "require'telescope.builtin'.git_files")
        { desc = "Find git file"; }
      ]
      [
        "n"
        "<Leader>fg"
        (luaExpr "require'telescope.builtin'.live_grep")
        { desc = "Find line"; }
      ]
      [
        "n"
        "<Leader>fb"
        (luaExpr "require'telescope.builtin'.buffers")
        { desc = "Find buffer"; }
      ]
      [
        "n"
        "<Leader>fh"
        (luaExpr "require'telescope.builtin'.help_tags")
        { desc = "Find help tag"; }
      ]
      [
        "n"
      ...
      [
        "n"
        "<Leader>fT"
        (luaExpr "require'telescope.builtin'.tags")
        { desc = "Find help tag"; }
      ]
      [
        "n"
        "<Leader>fc"
        (luaExpr "require'telescope.builtin'.commands")
        { desc = "Find command"; }
      ]
      [
        "n"
        "<Leader>fq"
        (luaExpr "require'telescope.builtin'.quickfix")
      ...
      [
        "n"
        "<Leader>wo"
        (luaExpr "require'telescope.builtin'.lsp_document_symbols")
